...
exports.index = function(req, res){
	...
	client.get("http://lab3.cfapps.io/gumballs.json", 
...
exports.GumballAction=function(req,res){
	...
	if(event==='TurnTheCrank' && state==='HasACoin'){
		...
		client.get("http://lab3.cfapps.io/gumballs.json", function(data, response){
			var ar={};
            ...
            if(count!==0){
            	...
            	client.put("http://lab3.cfapps.io/gumballs/1", args, function(data,response) {
